...
public class InputSearchKeyActivity extends PreferenceActivity implements ShortcutPickHelper.OnPickListener {
    ...
    private static final String MAGIC_WAKE_PREF = "pref_magic_wake";
    ...
    private CheckBoxPreference mMagicWakePref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.input_magic_key_title);
        addPreferencesFromResource(R.xml.input_search_key_settings);

        PreferenceScreen prefSet = getPreferenceScreen();
        /* Magic Wake */
        mMagicWakePref = (CheckBoxPreference) prefSet.findPreference(MAGIC_WAKE_PREF);
        mMagicWakePref.setChecked(Settings.System.getInt(getContentResolver(),
                Settings.System.MAGIC_PRESS_WAKE_SCREEN, 1) == 1);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mCustomSearchAppTogglePref) {
            ...
            return true;
        } else if (preference == mMagicWakePref) {
            value = mMagicWakePref.isChecked();
            Settings.System.putInt(getContentResolver(), Settings.System.MAGIC_PRESS_WAKE_SCREEN,
                    value ? 1 : 0);
            return true;
